...
public class FrameVolunteerHours extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		setFrameIcon(new ImageIcon(
				FrameVolunteerHours.class.getResource("/org/pantry/food/resources/images/telephone.png")));
		setName("Form");
		...
		btnAdd.setIcon(new ImageIcon(
				FrameVolunteerHours.class.getResource("/org/pantry/food/resources/images/telephone_add.png")));
		...
		btnEdit.setIcon(new ImageIcon(
				FrameVolunteerHours.class.getResource("/org/pantry/food/resources/images/telephone_edit.png")));
		...
		btnDelete.setIcon(new ImageIcon(
				FrameVolunteerHours.class.getResource("/org/pantry/food/resources/images/telephone_delete.png")));
		...
		}, new String[] { "VH ID", "Num Adults", "Adult Hrs", "Num Students", "Student Hrs", "Comment",
				"Entry Date" }) {
	...
	private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (record != null) {
			...
			int result = JOptionPane.showConfirmDialog(this,
					"Are you sure you want to delete the selected volunteer hours?", "Confirm",
