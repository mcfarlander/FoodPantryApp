...
public class FrameReportMonthlySummary extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		setFrameIcon(new ImageIcon(
				FrameReportMonthlySummary.class.getResource("/org/pantry/food/resources/images/report_key.png")));
		setName("Form");
		...
		btnPrint.setIcon(new ImageIcon(
				FrameReportMonthlySummary.class.getResource("/org/pantry/food/resources/images/printer.png")));
		...
		btnSave.setIcon(new ImageIcon(
				FrameReportMonthlySummary.class.getResource("/org/pantry/food/resources/images/report_disk.png")));
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null, null, null, null, null, null, null },
						...
						{ null, null, null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null, null, null } },
				new String[] { "ID", "HouseholdId", "New?", "# Adults", "# Kids", "Working Income", "Other Income",
						"No Income", "Date" }) {
	...
	private void loadReport() {
		try {
			...
			for (int i = 0; i < weekNumbers.size(); i++) {
				...
				for (int j = 0; j < monthVisits.size(); j++) {
					...
					if (vis.getVisitorWeekNumber() == iWeekNumber) {
						...
						String[] row = { "" + weekSumHouse, "" + vis.getHouseholdId(), sNew, "" + vis.getNumberAdults(),
								"" + vis.getNumberKids(), sWorking, sOther, sNoIncome,
				...
				String[] weekRow = { "Week Sum:", "w=" + weekSumHouse, "w=" + weekSumNew, "w=" + weekSumAdults,
						"w=" + weekSumKids, "w=" + weekSumWorkingIncome, "w=" + weekSumOtherIncome,
						"w=" + weekSumNoIncome, "Week " + (i + 1) };
			...
			String[] monthRow = { "Month Totals:", "T=" + monthSumHouse, "T=" + monthSumNew, "T=" + monthSumAdults,
					"T=" + monthSumKids, "T=" + monthSumWorkingIncome, "T=" + monthSumOtherIncome,
					"T=" + monthSumNoIncome, "Month Summary"
