...
public class FrameVolunteers extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		jButton1.setIcon(
				new ImageIcon(FrameVolunteers.class.getResource("/org/pantry/food/resources/images/user_add.png")));
		...
		jButton2.setIcon(
				new ImageIcon(FrameVolunteers.class.getResource("/org/pantry/food/resources/images/user_edit.png")));
		...
		jButton3.setIcon(
				new ImageIcon(FrameVolunteers.class.getResource("/org/pantry/food/resources/images/user_delete.png")));
		...
		}, new String[] { "Volunteer ID", "Name", "Phone", "Email", "Type", "Note" }) {
	...
	private void deactivate(java.awt.event.ActionEvent evt) {
		...
		if (del != null) {
			...
			int result = JOptionPane.showConfirmDialog(this,
					"Are you sure you want to deactivate the selected volunteer?", "Confirm",
	...
	/** The obj io. */
	private VolunteersDao objIo = new VolunteersDao();
...
//			Calendar visCal = Calendar.getInstance();
			...
			for (Volunteer obj : objIo.getAll()) {
			...
			JOptionPane.showMessageDialog(this,
					"Problem with the file: found, but it is incorrect.\n" + ex.getMessage());
	...
	private Volunteer getSelected() {
		...
		if (irow > -1) {
			...
			for (Volunteer test : objIo.getAll()) {
