...
public class FrameCustomers extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		setTitle("Customers");
		setFrameIcon(
				new ImageIcon(FrameCustomers.class.getResource("/org/pantry/food/resources/images/table_key.png")));
		setName("Form");
		...
		btnAdd.setIcon(
				new ImageIcon(FrameCustomers.class.getResource("/org/pantry/food/resources/images/table_add.png")));
		...
		btnEdit.setIcon(
				new ImageIcon(FrameCustomers.class.getResource("/org/pantry/food/resources/images/table_edit.png")));
		...
		btnDelete.setIcon(
				new ImageIcon(FrameCustomers.class.getResource("/org/pantry/food/resources/images/table_delete.png")));
		...
		}, new String[] { "Customer Id", "HouseHold Id", "Person Id", "Gender", "Birth Date", "Age", "Month Registered",
				"New?", "Comments", "Active?" }) {
	...
	private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (newCust != null) {
			...
			int result = JOptionPane.showConfirmDialog(this,
					"Are you sure you want to deactivate the selected customer?", "Confirm", JOptionPane.YES_NO_OPTION);
