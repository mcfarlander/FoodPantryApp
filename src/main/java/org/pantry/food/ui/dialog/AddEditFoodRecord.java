...
public class AddEditFoodRecord extends JDialog {
	...
	private void initComponents()
	{
		...
		btnOk.setIcon(new ImageIcon(AddEditFoodRecord.class.getResource("/org/pantry/food/resources/images/accept.png"))); 
		btnOk.setText("OK"); 
		btnOk.setName("btnOk"); 
		...
		btnCancel.setIcon(new ImageIcon(AddEditFoodRecord.class.getResource("/org/pantry/food/resources/images/cancel.png"))); 
    ...
    private void setControlsFromPrevious() {
        ...
        this.txtOther2.setText("" + this.record.getOther2());
    ...
    private void generateRecord() {
        ...
        this.record.setOther2(Double.parseDouble(this.txtOther2.getText()));
