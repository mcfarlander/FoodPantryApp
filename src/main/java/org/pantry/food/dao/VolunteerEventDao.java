...
public class VolunteerEventDao implements CsvDao<VolunteerEvent> 
{
    ...
    private ArrayList<VolunteerEvent> csvList = new ArrayList<VolunteerEvent>();

    public ArrayList<VolunteerEvent> getCvsList(){return this.csvList;}
     ...
     */
    public List<VolunteerEvent> readCsvFile() throws FileNotFoundException, IOException
    {
