...
public class VolunteerDao implements CsvDao<Volunteer> {
	...
	private List<Volunteer> csvList = new ArrayList<Volunteer>();
	...
	public void persist() throws IOException {
		...
		String[] titles = { Col_VolunteerId, Col_Name, Col_Phone, Col_Email, Col_Type, Col_Note };
	...
	@Override
	public void deactivate(Volunteer vol) {
		for (int i = 0; i < csvList.size(); i++) {
