...
public class MainDesktopView extends FrameView {
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				.getInstance(org.pantry.food.FoodPantryApp.class).getContext().getResourceMap(MainDesktopView.class);
		...
		mnuCustomers.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
		mnuCustomers.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/table_key.png")));
		...
		mnuVisits.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.CTRL_MASK));
		mnuVisits.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/cart.png")));
		...
		mnuItemFoodRecords.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.CTRL_MASK));
		mnuItemFoodRecords.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/tag_blue.png")));
		...
		mnuVolunteerHours.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.CTRL_MASK));
		mnuVolunteerHours.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/telephone.png")));
		...
		mnuVolunteers.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_W, java.awt.event.InputEvent.CTRL_MASK));
		mnuVolunteers.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/user.png")));
		...
		mnuVolunteerEvents.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_MASK));
		mnuVolunteerEvents.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/user_go.png")));
		...
		mnuReports.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_MASK));
		mnuReports.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/report.png")));
		...
		mnuSettings.setAccelerator(
				javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_MASK));
		mnuSettings.setIcon(new ImageIcon(
				MainDesktopView.class.getResource("/org/pantry/food/resources/images/wrench_orange.png")));
		...
		exitMenuItem.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/cancel.png")));
		...
		;
		mnuAbout.setIcon(
				new ImageIcon(MainDesktopView.class.getResource("/org/pantry/food/resources/images/help.png")));
	...
	private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {
		 ...
		 * dial.setLocationRelativeTo(this.getFrame()); dial.setVisible(true);
		 * 
		 * if (dial.getOkCancel()) {
		 * 
		 ...
		 * 
		 * case 0: ReportMonthlySummary reportMonthSummary = new ReportMonthlySummary();
		 * reportMonthSummary.setMonthSelected(dial.getMonthSelected());
		 * reportMonthSummary.createReport();
		 * reportViewer.setDisplayFromIReport(reportMonthSummary);
		 * 
		 * break;
		 * 
		 * 
		 * case 1: ReportDonatedFoodWeight reportDonatedFood = new
		 * ReportDonatedFoodWeight(); reportDonatedFood.createReport();
		 * reportViewer.setDisplayFromIReport(reportDonatedFood);
		 * 
		 * break;
		 * 
		 * case 2: ReportVolunteerHours reportVolunteerHours = new
		 * ReportVolunteerHours(); reportVolunteerHours.createReport();
		 * reportViewer.setDisplayFromIReport(reportVolunteerHours);
		 * 
		 * case 3: ReportVolunteerEvents reportVolunteerEvents = new
		 * ReportVolunteerEvents(); reportVolunteerEvents.createReport();
		 * reportViewer.setDisplayFromIReport(reportVolunteerEvents); break;
		 * 
		 * case 4: ReportPantrySummary report= new ReportPantrySummary();
		 * report.setMonthSelected(dial.getMonthSelected()); report.createReport();
		 * reportViewer.setDisplayFromIReport(report);
		 * 
		 * default: break; }
		 * 
		 * try { this.jDesktopPane1.add(reportViewer); reportViewer.setMaximum(true);
		 * reportViewer.setVisible(true);
		 * 
		 * FormState.getInstance().setFormOpen(true, reportViewer);
		 * 
		 * } catch (PropertyVetoException ex) {
		 * Logger.getLogger(MainDesktopView.class.getName()).log(Level.SEVERE, null,
		 * ex); }
		 * 
		 ...
		 * }
		 * 
		 * } else { JOptionPane.showMessageDialog(this.getFrame(),
		 * "Please close open window first."); }
		 * 
		 */
	}
