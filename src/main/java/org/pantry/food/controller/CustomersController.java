...
public class CustomersController {
	...
	public void initialize() {
		addCustomerBtn.setGraphic(new ImageView(Images.getIcon("table_add.png")));
		addCustomerBtn.setOnAction(new EventHandler<ActionEvent>() {

			@Override
			public void handle(ActionEvent event) {
				// Invoke the Add listener
			}
        	
        });
		
		editCustomerBtn.setGraphic(new ImageView(Images.getIcon("table_edit.png")));
		...
		deleteCustomerBtn.setGraphic(new ImageView(Images.getIcon("table_delete.png")));
        ...
        for (TableColumn<?, ?> column: dataTable.getColumns()) {
        	// The ID of each column is the name of the corresponding property in the Customer object
        	
        	// Boolean columns have to be treated differently if we want them to display a checkbox
