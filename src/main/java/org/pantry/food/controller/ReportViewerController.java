...
public class ReportViewerController extends AbstractController<Visit, AddEditVisitDialogInput> {

	private final static Logger log = LogManager.getLogger(ReportViewerController.class);
