...
public class ReportPantrySummary extends ReportBase
{
    ...
    private void getCustomerData() throws FileNotFoundException, IOException
    {
        ...
        {
            Customer cust = custs.getCustomerList().get(i);
            numberCustomers++;
        ...
        createRow("New Customers Month", "" + numberMonthCustomers, 
        		"Adults:" + numberMonthAdults + " Seniors:" + numberMonthSeniors + " Children:" + numberMonthKids + 
        		" Households:" + distinctHouseholdsMonth.size(), false);
        
        createRow("New Customers YTD", "" + numberCustomers, 
        		"Adults:" + numberNewAdults + 
        		" Seniors:" + numberNewSeniors +
        		" Children:" + numberNewKids +
        		" Households:" + distinctHouseholdsYtd.size(), false);
    ...
    private void getVisitsData() throws FileNotFoundException, IOException, ParseException
    {
        ...
        {
        	Visit visit = visits.getVisitList().get(i);
    ...
    private void getVolunteerData() throws FileNotFoundException, IOException, ParseException
    {
    	...
    	{
    		VolunteerEvent event = (VolunteerEvent)events.getCvsList().get(i);
    	...
    	createRow("Total Hours", "" + nf.format(totalHours), "Count:" + (distinctStudents.size() + distinctRegulars.size() + distinctOthers.size()), false);
    ...
    private void getDonationData() throws FileNotFoundException, IOException, ParseException
    {
    	...
    	{
    		FoodRecord record = records.getRecordList().get(i);
