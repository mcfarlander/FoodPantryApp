...
public class ReportVolunteerEvents  extends ReportBase 
{
    ...
    private String[] cols = new String [] {
        "Volunteer", "Type", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Total"
    };
    
    private VolunteerDao volunteerIO = new VolunteerDao(); // used to find the type of volunteer based on voluneer's name
    ...
    private void createRow(String col1, String col2, 
    		String col3, String col4, String col5, 
    		String col6, String col7, String col8,
    ...
    private void loadReport(){
        try 
        {
            ...
            // do them by type
             ...
             for (int j = 0; j < 5; j++)
             {
                 ...
                 for (int i = 0; i < vols.size(); i++)
                 {
                	 ...
                	 if (type == j)
                	 {
                		 ...
                		 // add a row
	                	 createRow(vol.getVolunteerName(), "", 
	                			 "" + vol.getMonthHrs()[0], "" + vol.getMonthHrs()[1], "" + vol.getMonthHrs()[2], "" + vol.getMonthHrs()[3],
	                			 "" + vol.getMonthHrs()[4], "" + vol.getMonthHrs()[5], "" +vol.getMonthHrs()[6], "" + vol.getMonthHrs()[7],
	                			 "" + vol.getMonthHrs()[8], "" + vol.getMonthHrs()[9], "" + vol.getMonthHrs()[10],"" +  vol.getMonthHrs()[11],
	                			 "" + vol.getVolunteerHours(), false, false
	                			 );
                	 }
                	 
                 } // loop thru volunteers
                 
                 createRow("  Group Totals", "", 
            			 "" + groupMonthTotals[0], "" + groupMonthTotals[1], "" + groupMonthTotals[2], "" + groupMonthTotals[3],
            			 "" + groupMonthTotals[4], "" + groupMonthTotals[5], "" + groupMonthTotals[6], "" + groupMonthTotals[7],
            			 "" + groupMonthTotals[8], "" + groupMonthTotals[9], "" + groupMonthTotals[10],"" + groupMonthTotals[11],
            			 "" + groupTotal, false, true
            			 );
             ...
             createRow("", "", 
            		 "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "" , false, false);
             
             createRow("  Month Totals", "", 
        			 "" + monthTotals[0], "" + monthTotals[1], "" + monthTotals[2], "" + monthTotals[3],
        			 "" + monthTotals[4], "" + monthTotals[5], "" + monthTotals[6], "" + monthTotals[7],
        			 "" + monthTotals[8], "" + monthTotals[9], "" + monthTotals[10],"" +monthTotals[11],
        			 "" + yearTotal, false, true
        			 );
